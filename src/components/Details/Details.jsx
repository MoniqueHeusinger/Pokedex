								...
								<div className='pokemon_color'>
									...
									<div className='silver_block'>
										...
										{singelData.moves.length > 2 ? (
											<Link
												to={`/more-moves/${pokeParams.id}`}>
												<p className='more_moves'>
													all
												</p>
											</Link>
										) : (
								...
								<div className='pokemon_color'>
									...
									<div className='pokemon_ability'>
										...
										<div className='silver_block'>
											<p>
												{
													singelData.abilities[0]
														?.ability.name
												}
											</p>
											<p>
												{
													singelData.abilities[1]
														?.ability.name
												}
											</p>
											{singelData.abilities.length > 2 ? (
												<Link
													to={`/more-abilities/${pokeParams.id}`}>
													<p>all</p>
												</Link>
											) : (
												<span></span>
